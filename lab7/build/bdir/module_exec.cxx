...
MOD_module_exec::MOD_module_exec(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34(66u)
{
				  ...
				  tUInt32 ARG_exec_csrVal)
{
  ...
  DEF_x__h443 = ARG_exec_dInst.get_whole_word(0u);
  DEF_IF_exec_dInst_BIT_32_3_THEN_exec_dInst_BITS_31_ETC___d15 = DEF_x__h443;
  ...
  DEF_aluVal2__h29 = ARG_exec_dInst.get_bits_in_word8(1u,
						      0u,
						      1u) ? DEF_IF_exec_dInst_BIT_32_3_THEN_exec_dInst_BITS_31_ETC___d15 : ARG_exec_rVal2;
  ...
  case (tUInt8)2u:
  case (tUInt8)3u:
    DEF_x__h417 = DEF_aluRes__h30;
    break;
  default:
    DEF_x__h417 = DEF_brAddr__h36;
  }
  DEF_exec_pc_PLUS_4___d11 = ARG_exec_pc + 4u;
  switch (DEF_exec_dInst_BITS_74_TO_71___d1) {
  case (tUInt8)7u:
    DEF_x__h263 = ARG_exec_csrVal;
    break;
  case (tUInt8)8u:
    DEF_x__h263 = ARG_exec_rVal1;
    break;
  case (tUInt8)3u:
    DEF_x__h263 = ARG_exec_rVal2;
    break;
  case (tUInt8)4u:
  case (tUInt8)5u:
    DEF_x__h263 = DEF_exec_pc_PLUS_4___d11;
    break;
  case (tUInt8)9u:
    DEF_x__h263 = ARG_exec_pc + DEF_IF_exec_dInst_BIT_32_3_THEN_exec_dInst_BITS_31_ETC___d15;
    break;
  default:
    DEF_x__h263 = DEF_aluRes__h30;
  }
  DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34.set_bits_in_word((tUInt8)(DEF_x__h263 >> 30u),
										2u,
										0u,
										2u).set_whole_word((((tUInt32)(1073741823u & DEF_x__h263)) << 2u) | (tUInt32)((tUInt8)(DEF_x__h417 >> 30u)),
												   1u).set_whole_word(((((tUInt32)(1073741823u & DEF_x__h417)) << 2u) | (((tUInt32)(!(DEF_brAddr__h36 == ARG_exec_ppc))) << 1u)) | (tUInt32)(DEF_aluBr___d28),
														      0u);
  DEF_exec_dInst_BITS_63_TO_58_CONCAT_exec_dInst_BIT_ETC___d4 = 524287u & ((((tUInt32)(ARG_exec_dInst.get_bits_in_word8(1u,
															...
															6u))) << 13u) | ARG_exec_dInst.get_bits_in_word32(1u,
																					  1u,
																					  13u));
  PORT_exec.set_bits_in_word(33554431u & (((((tUInt32)(DEF_exec_dInst_BITS_74_TO_71___d1)) << 21u) | (DEF_exec_dInst_BITS_63_TO_58_CONCAT_exec_dInst_BIT_ETC___d4 << 2u)) | (tUInt32)(DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34.get_bits_in_word8(2u,
																																     0u,
																																     2u))),
			     2u,
			     0u,
			     25u).set_whole_word(DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34.get_whole_word(1u),
						 1u).set_whole_word(DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34.get_whole_word(0u),
								    0u);
  return PORT_exec;
}
...
unsigned int MOD_module_exec::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34", 66u);
...
void MOD_module_exec::vcd_defs(tVCDDumpType dt, MOD_module_exec &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
    ...
    {
      if ((backing.DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34) != DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34)
      {
	vcd_write_val(sim_hdl, num, DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34, 66u);
	backing.DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34 = DEF_IF_exec_dInst_BITS_74_TO_71_EQ_7_THEN_exec_csr_ETC___d34;
      }
      ++num;
