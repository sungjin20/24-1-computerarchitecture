...
MOD_module_decode::MOD_module_decode(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent), DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184(67u)
{
...
{
  tUInt32 DEF_x__h1737;
  tUInt32 DEF_x__h1650;
  tUInt32 DEF_x__h1562;
  tUInt8 DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b1101111_3___d113;
  tUInt8 DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b10111_2___d112;
  ...
  tUInt8 DEF_IF_decode_inst_BITS_14_TO_12_EQ_0b101_2_THEN_I_ETC___d57;
  ...
  tUInt8 DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_THEN_de_ETC___d144;
  tUInt8 DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d97;
  tUInt8 DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d128;
  ...
  DEF_x__h1463 = (tUInt32)(ARG_decode_inst >> 20u);
  DEF_immI__h23 = primSignExt32(32u, 12u, (tUInt32)(DEF_x__h1463));
  ...
  case (tUInt8)55u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d128 = (tUInt8)0u;
    break;
  default:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d128 = DEF_rs1__h20;
  }
  switch (DEF_opcode__h17) {
  default:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d97 = DEF_decode_inst_BITS_11_TO_7___d37;
  }
  switch (DEF_opcode__h17) {
  default:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_THEN_de_ETC___d144 = DEF_rs2__h21;
  }
  ...
  switch (DEF_funct3__h19) {
  case (tUInt8)1u:
    DEF_IF_decode_inst_BITS_14_TO_12_EQ_0b1_1_THEN_IF__ETC___d44 = DEF_decode_inst_BITS_11_TO_7___d37 == (tUInt8)0u ? (tUInt8)8u : (tUInt8)0u;
    break;
  case (tUInt8)2u:
  ...
  DEF_IF_decode_inst_BITS_14_TO_12_EQ_0b101_2_THEN_I_ETC___d57 = DEF_decode_inst_BIT_30___d55 ? (tUInt8)8u : (tUInt8)9u;
  switch (DEF_funct3__h19) {
  case (tUInt8)0u:
  ...
  case (tUInt8)1u:
    ...
    break;
  default:
    DEF_IF_decode_inst_BITS_14_TO_12_EQ_0b0_THEN_0_ELS_ETC___d64 = DEF_IF_decode_inst_BITS_14_TO_12_EQ_0b101_2_THEN_I_ETC___d57;
  }
  switch (DEF_funct3__h19) {
  case (tUInt8)0u:
  ...
  case (tUInt8)1u:
    ...
    break;
  default:
    DEF_IF_decode_inst_BITS_14_TO_12_EQ_0b0_THEN_IF_de_ETC___d66 = DEF_IF_decode_inst_BITS_14_TO_12_EQ_0b101_2_THEN_I_ETC___d57;
  }
  switch (DEF_opcode__h17) {
  case (tUInt8)19u:
  ...
  DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b10111_2___d112 = !DEF_decode_inst_BITS_6_TO_0_EQ_0b10111___d22;
  DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b1101111_3___d113 = !DEF_decode_inst_BITS_6_TO_0_EQ_0b1101111___d23;
  DEF_x__h1562 = 2097151u & (((((((tUInt32)(DEF_decode_inst_BIT_31___d158)) << 20u) | (((tUInt32)((tUInt8)((tUInt8)255u & (ARG_decode_inst >> 12u)))) << 12u)) | (((tUInt32)((tUInt8)((tUInt8)1u & (ARG_decode_inst >> 20u)))) << 11u)) | (((tUInt32)(1023u & (ARG_decode_inst >> 21u))) << 1u)) | (tUInt32)((tUInt8)0u));
  DEF_immJ__h27 = primSignExt32(32u, 21u, (tUInt32)(DEF_x__h1562));
  DEF_x__h1650 = 8191u & (((((((tUInt32)(DEF_decode_inst_BIT_31___d158)) << 12u) | (((tUInt32)((tUInt8)((tUInt8)1u & (ARG_decode_inst >> 7u)))) << 11u)) | (((tUInt32)((tUInt8)((tUInt8)63u & (ARG_decode_inst >> 25u)))) << 5u)) | (((tUInt32)((tUInt8)((tUInt8)15u & (ARG_decode_inst >> 8u)))) << 1u)) | (tUInt32)((tUInt8)0u));
  DEF_immB__h25 = primSignExt32(32u, 13u, (tUInt32)(DEF_x__h1650));
  DEF_x__h1737 = 4095u & ((((tUInt32)((tUInt8)(ARG_decode_inst >> 25u))) << 5u) | (tUInt32)(DEF_decode_inst_BITS_11_TO_7___d37));
  DEF_immS__h24 = primSignExt32(32u, 12u, (tUInt32)(DEF_x__h1737));
  switch (DEF_opcode__h17) {
  case (tUInt8)3u:
  case (tUInt8)19u:
  case (tUInt8)103u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d181 = DEF_immI__h23;
    break;
  case (tUInt8)23u:
  case (tUInt8)55u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d181 = DEF_immU__h26;
    break;
  case (tUInt8)111u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d181 = DEF_immJ__h27;
    break;
  case (tUInt8)99u:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d181 = DEF_immB__h25;
    break;
  default:
    DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d181 = DEF_immS__h24;
  }
  DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184.set_bits_in_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d88,
										 2u,
										 0u,
										 3u).build_concat(!(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d97 == (tUInt8)0u) && (DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d2 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d3 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b110111___d21 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b10111___d22 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1101111___d23 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100111___d24 || (!DEF_decode_inst_BITS_6_TO_0_EQ_0b1100011___d25 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b11___d32 || DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011___d36)))))))),
												  ...
												  1u).set_bits_in_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d97,
														       1u,
														       26u,
														       5u).set_bits_in_word(DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d2 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d3 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b110111___d21 || (DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b10111_2___d112 && (DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b1101111_3___d113 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100111___d24 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100011___d25 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b11___d32 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b100011___d34 || DEF_decode_inst_BITS_6_TO_0_EQ_0b1110011___d36)))))))),
																	    1u,
																	    25u,
																	    1u).set_bits_in_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d128,
																				 1u,
																				 20u,
																				 5u).set_bits_in_word(!DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d2 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d3 || (!DEF_decode_inst_BITS_6_TO_0_EQ_0b110111___d21 && (DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b10111_2___d112 && (DEF_NOT_decode_inst_BITS_6_TO_0_EQ_0b1101111_3___d113 && (!DEF_decode_inst_BITS_6_TO_0_EQ_0b1100111___d24 && (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100011___d25 || DEF_decode_inst_BITS_6_TO_0_EQ_0b100011___d34)))))),
																						      1u,
																						      19u,
																						      1u).set_bits_in_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b110011_THEN_de_ETC___d144,
																									   1u,
																									   14u,
																												...
																												1u).set_bits_in_word((tUInt32)(4095u & DEF_immI__h23),
																														     ...
																														     12u).set_bits_in_word(DEF_decode_inst_BITS_6_TO_0_EQ_0b10011___d2 || (!DEF_decode_inst_BITS_6_TO_0_EQ_0b110011___d3 && ((DEF_decode_inst_BITS_6_TO_0_EQ_0b110111___d21 || DEF_decode_inst_BITS_6_TO_0_EQ_0b10111___d22) || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1101111___d23 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100111___d24 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b1100011___d25 || (DEF_decode_inst_BITS_6_TO_0_EQ_0b11___d32 || DEF_decode_inst_BITS_6_TO_0_EQ_0b100011___d34)))))),
																																	   ...
																																	   1u).set_whole_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_SEX_ETC___d181,
																																			      0u);
  PORT_decode.set_bits_in_word(2047u & (((((tUInt32)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_1_E_ETC___d54)) << 7u) | (((tUInt32)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_THEN_IF__ETC___d75)) << 3u)) | (tUInt32)(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184.get_bits_in_word8(2u,
																																					    0u,
																																					    3u))),
			       2u,
			       0u,
			       11u).set_whole_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184.get_whole_word(1u),
						   1u).set_whole_word(DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184.get_whole_word(0u),
								      0u);
  return PORT_decode;
}
...
unsigned int MOD_module_decode::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184", 67u);
...
void MOD_module_decode::vcd_defs(tVCDDumpType dt, MOD_module_decode &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
    ...
    {
      if ((backing.DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184) != DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184)
      {
	vcd_write_val(sim_hdl, num, DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184, 67u);
	backing.DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184 = DEF_IF_decode_inst_BITS_6_TO_0_EQ_0b10011_OR_decod_ETC___d184;
      }
      ++num;
